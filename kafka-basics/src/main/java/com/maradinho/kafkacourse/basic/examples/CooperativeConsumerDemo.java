...
public class CooperativeConsumerDemo {
    private static  final Logger log = LoggerFactory.getLogger(CooperativeConsumerDemo.class);

    public static void main(String[] args) {
        log.info("Kafka cooperative consumer with shutdown hook execution starts");
